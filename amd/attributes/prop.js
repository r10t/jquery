define(['../core', '../var/isIE', '../selector', '../core/access'], function (core, isIE, selector, access) { 'use strict';
...
core.fn.extend( {
	prop: function( name, value ) {
		return access( this, core.prop, name, value, arguments.length > 1 );
	},

	removeProp: function( name ) {
		return this.each( function() {
			delete this[ core.propFix[ name ] || name ];
		} );
	}
} );
...
core.extend( {
	prop: function( elem, name, value ) {
		...
		if ( nType !== 1 || !core.isXMLDoc( elem ) ) {
			...
			name = core.propFix[ name ] || name;
			hooks = core.propHooks[ name ];
		}
...
core.each( [
	...
	core.propFix[ this.toLowerCase() ] = this;
} );
